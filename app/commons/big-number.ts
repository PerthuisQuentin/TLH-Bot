...
export function bnLn(a: BigNumSource): BigNum {
    return bn(a).ln();
}
...
/**
 * Sérialise un BigNum en string pour stockage JSON.
 * Ex : 1 234 567 → "1234567" (decimal.js utilise la notation complète
 * pour les petits nombres, et la notation exponentielle pour les très grands)
 */
export function bnToJSON(n: BigNum): string {
    return n.toJSON();
}
